...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/login/**").hasAnyAuthority("ADMIN", "USER", "DRIVER")
                .antMatchers("/drivers/**").hasAnyAuthority("ADMIN", "USER","DRIVER")
                .antMatchers("/cars/**").hasAnyAuthority("ADMIN", "USER")
                .antMatchers("/orders/**").hasAnyAuthority("ADMIN", "USER","DRIVER")
                ...
                .antMatchers("/role/**").hasAnyAuthority("ADMIN", "USER")
